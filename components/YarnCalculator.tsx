...
export default function YarnCalculator() {
  ...
  const addYarn = () => {
    ...
    setYarns([
      ...yarns,
      { id: newId, weight: "100", length: "", strands: "1" },
    ]);
  };
  ...
  const validateYarn = (
    yarn: YarnInput
  ): { weight?: string; length?: string; strands?: string } => {
  ...
  return (
    <div
      className="min-h-screen p-2 sm:p-4 md:p-8 bg-cover bg-center bg-no-repeat relative"
      style={{ backgroundImage: "url('/yarn_background.png')" }}
    >
      <div className="absolute inset-0 bg-gradient-to-br from-purple-50/75 to-pink-50/75 dark:from-gray-900/85 dark:to-gray-800/85 z-0" />
          ...
          <div className="space-y-3 sm:space-y-4">
            {yarns.map((yarn, index) => (
              ...
              >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1">
                      <input
                        ...
                        value={yarn.weight}
                        onChange={(e) =>
                          updateYarn(yarn.id, "weight", e.target.value)
                        }
                        placeholder="100"
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1">
                      <input
                        ...
                        value={yarn.length}
                        onChange={(e) =>
                          updateYarn(yarn.id, "length", e.target.value)
                        }
                        placeholder="700"
                        className={`w-full px-2 py-1.5 sm:px-3 sm:py-2 text-sm border-2 rounded-lg focus:ring-2 dark:bg-gray-700 dark:text-white ${
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1">
                      <input
                        ...
                        value={yarn.strands}
                        onChange={(e) =>
                          updateYarn(yarn.id, "strands", e.target.value)
                        }
                        placeholder="2"
                        className={`w-full px-2 py-1.5 sm:px-3 sm:py-2 text-sm border-2 rounded-lg focus:ring-2 dark:bg-gray-700 dark:text-white ${
                ...
                <div className="mt-2 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                  Метраж на 100г:{" "}
                  {parseFloat(yarn.weight) > 0
                    ? (
                        (parseFloat(yarn.length) / parseFloat(yarn.weight)) *
                        100
                      ).toFixed(2)
                    : 0}{" "}
                  м
            ...
            {result !== null && (
              <div className="mt-3 sm:mt-4 p-3 sm:p-4 md:p-6 bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border-2 border-green-300 dark:border-green-700 rounded-lg md:rounded-xl">
                ...
                <div className="space-y-1 text-sm sm:text-base text-gray-700 dark:text-gray-300">
                  <p>
                    <span className="font-semibold">Всего нитей:</span>{" "}
                    {getTotalStrands()} шт
                  </p>
            ...
            <div className="mt-4 sm:mt-6 p-3 sm:p-4 md:p-6 bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-200 dark:border-blue-700 rounded-lg md:rounded-xl">
              ...
              <p className="text-xs sm:text-sm text-gray-700 dark:text-gray-300">
                При сложении нескольких нитей пряжи вместе, итоговый метраж
                ...
                <br />
                Где каждый метраж приведен к 100 граммам и учитывает количество
                нитей.
              </p>
            </div>
          </div>
